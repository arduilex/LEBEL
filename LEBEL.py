...
# Ce programme est la v3.4 du projet LEBEL
...
def save(list1, list2, list3, list4, list5, list6, var):
    ...
    f = open(('SCORE ('+list4[2]+').txt'), 'w', encoding='Utf-8')    # Ouverture du fichier score.txt en écriture avec l'encodage 'Utf-8'
...
def init():
    ...
    list4 = ['']*3  # Initialisation de la liste <list4> à trois index vide
    ...
    # FICHIER SCORE
    try:
        f = open(('SCORE ('+list4[2]+').txt'), 'r', encoding='Utf-8')     # Ouverture en mode lectue avec l'encodage 'Utf-8' du fichier score.txt
    except:
        f = open(('SCORE ('+list4[2]+').txt'), 'w', encoding='Utf-8')
        f.write("###############\nBASE NOTE = 20\nMOYENNE = 0/20\n###############\n\n")      # Ecriture avec encadré de la nouvelle base
        f.close()
        f = open(('SCORE ('+list4[2]+').txt'), 'r', encoding='Utf-8')     # Ouverture en mode lectue avec l'encodage 'Utf-8' du fichier score.txt
